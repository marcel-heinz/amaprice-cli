    ...
    <>
      ...
      <main className="container">
        <section className="hero prices-hero">
          ...
          <h1>Search tracked products and inspect every price point.</h1>
          <p className="lead">
            Use the explorer to open any tracked product, switch ranges quickly,
            and view each tracked price point in a clearer timeline.
          </p>
